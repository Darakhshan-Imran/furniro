...
//         w-full max-w-[30%] sm:max-w-[45%] md:max-w-[60%] lg:max-w-[50%] xl:max-w-[40%] 
//          bg-[#FFF3E3] 
//         p-4 sm:p-8 md:p-10 lg:p-12 xl:p-14 z-10 mx-4 sm:mx-10"
//       >
        
//         <div className="flex flex-col gap-6 justify-start p-2">
