...
const Footer = () => {
  return (
    ...
    <section className="flex flex-col items-center justify-center px-4 py-6 sm:px-8">
  ...
  {/* Footer */}
  <div className="flex flex-col md:flex-row items-center justify-center w-full md:w-[70rem] h-auto md:h-[5rem] mt-8 border-t-2 border-t-[#D9D9D9] px-4 md:px-40">
