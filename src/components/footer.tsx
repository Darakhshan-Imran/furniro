...
// const Footer = () => {
//   return (
//     <section className="flex flex-col items-center justify-center overflow-x-hidden py-6">
//       <div className="flex flex-col md:flex-row w-full md:h-[505px] mt-11 border-t-2 border-t-[#D9D9D9]">
//         {/* Brand Info */}
//         <div className="flex flex-col md:w-1/5 md:h-[60%] md:mt-[6rem] px-4">
//           <p className="text-xl sm:text-2xl font-semibold text-[#000000] py-3">Furniro.</p>
//           <p className="text-sm sm:text-base text-[#5b5a5a] mt-2">
//             University Road Suite 200, Karachi, PAKISTAN
//           </p>
//         </div>

//         {/* Links Section */}
//         <div className="flex flex-col justify-start items-start md:w-[90px] h-auto md:h-[312px] mt-8 md:mt-[6rem] px-4">
//           <p className="text-[#000000] font-semibold">Links</p>
//           <button className="font-medium text-[#5b5a5a] mt-4">Home</button>
//           <button className="font-medium text-[#5b5a5a] mt-4">Shop</button>
//           <button className="font-medium text-[#5b5a5a] mt-4">About</button>
//           <button className="font-medium text-[#5b5a5a] mt-4">Contact</button>
//         </div>

//         {/* Help Section */}
//         <div className="flex flex-col justify-start items-start w-auto md:w-[12rem] h-auto md:h-[312px] mt-8 md:mt-[6rem] px-4">
//           <p className="text-[#000000] font-semibold">Help</p>
//           <button className="font-medium text-[#5b5a5a] mt-4">Payment Options</button>
//           <button className="font-medium text-[#5b5a5a] mt-4">Returns</button>
//           <button className="font-medium text-[#5b5a5a] mt-4">Payment Policies</button>
//         </div>

//         {/* Newsletter Section */}
//         <div className="flex flex-col w-full mt-8 md:mt-[6rem] px-4 space-y-4">
//           <p className="text-[#000000] font-semibold">Newsletter</p>
//           <button className="font-medium text-[#5b5a5a] underline underline-offset-4">
//             Enter Your Email Address
//           </button>
...
//       {/* Footer */}
//       <div className="flex flex-col md:flex-row items-center justify-center w-full h-auto md:h-[5rem] mt-8 border-t-2 border-t-[#D9D9D9] px-4">
//         <p className="text-[#000000] mt-4 text-center">2023 Furniro. All rights reserved</p>
//       </div>
//     </section>
//   );
// };
